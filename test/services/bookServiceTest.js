...
describe('bookService', () => {
  ...
  describe('create', () => {
    ...
    context('when the book data is valid', () => {
      ...
      beforeEach(() => {
        // given
        bookData = { title: 'UnSuperLivre', authorId: 5}
    ...
    context('when the book title is missing', () => {
      ...
      beforeEach(() => {
        // given
        bookData = { title: undefined, authorId: 6}
    ...
    context('when the author tittle is empty', () => {

      beforeEach(() => {
        // given
        bookData = { title: '', authorId: 6}
    ...
    context('when the book authorId is missing', () => {

      beforeEach(() => {
        // given
        bookData = { title: 'mon titre de livre', authorId: undefined}
    ...
    context('when the book title and authorId are missing', () => {
