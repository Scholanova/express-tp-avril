    ...
    describe('authorService', () => {
      ...
      describe('create', () => {
        ...
        context('when the author name is missing', () => {
          ...
          beforeEach(() => {
            // given
            authorData = {  pseudo: 'JJR', email: 'jj@rousseau.ch', language: 'french' }
        ...
        context('when the author email is missing', () => {
          ...
          beforeEach(() => {
            // given
            authorData = { name: 'Jean-Jacques Rousseau', pseudo: 'JJR',  language: 'french' }
        ...
        context('when the author language is missing', () => {
          ...
          beforeEach(() => {
            // given
            authorData = { name: 'JeanJR', pseudo: 'JJR', email: 'jj@rousseau.ch' }
        ...
        context.skip('when the author language is neither french nor english', () => {
          ...
          beforeEach(() => {
            // given
            authorData = { name: 'JJRF', pseudo: 'JJR', email: 'jj@rousseau.ch', language: 'german' }
        ...
        describe('listForLanguage', () => {
            ...
            it('should reject with a ValidationError error about unsupported language', () => {
              // then
               ...
               const expectedError = [{
                          ...
                          path: ['language'],
                          type: 'any.only',
                          context: { label: 'language', key: 'language', valids: ['french', 'english'], 'value': 'senegal' }
                        }]
          ...
          let author_two
                  ...
                  beforeEach(() => {
                    ...
                    author_one = new Author({ name: 'Oneee', pseudo: 'On', email: 'One@rousseau.ch', language: 'french' })
                    author_two = new Author({ name: 'Twooo', pseudo: 'Tw', email: 'two@pullman.co.uk', language: 'french' })

                    authorRepository.listForLanguage.resolves([author_one, author_two])
            ...
            it('should resolve with the authors listed from reprository', () => {
              // then
               return expect(authorListForLanguagePromise).to.eventually.deep.equal([author_one, author_two])
