...
describe('authorService', () => {
  ...
  describe('create', () => {
    ...
    context('when the author data is valid', () => {
      ...
      beforeEach(() => {
        // given
        authorData = { name: 'Jean-Jacques Rousseau', pseudo: 'JJR', email: 'jj@rousseau.ch', language: 'english' }
    ...
    context('when the author name is empty', () => {
      ...
      beforeEach(() => {
        // given
        authorData = { name: '', pseudo: 'JJR', email: 'jj@rousseau.ch', language: 'english' }
    ...
    context('when the author email is missing', () => {
      ...
      beforeEach(() => {
        // given
        authorData = { name: 'Jean-Jacques', pseudo: 'JJR', email: undefined , language: 'english'}
    ...
    context('when the author language is missing', () => {
      ...
      beforeEach(() => {
        // given
        authorData = { name: 'JJRtest', pseudo: 'JJR', email: 'jj@rousseau.ch', language: undefined }
    ...
    context.skip('when the author language is neither french nor english', () => {
      ...
      beforeEach(() => {
        // given
        authorData = { name: 'JJRtest', pseudo: 'JJR', email: 'jj@rousseau.ch', language: 'german' }
